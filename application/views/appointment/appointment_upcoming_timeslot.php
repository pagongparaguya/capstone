                        ...
                        <thead>
                          ...
                          <tbody>
                            <tr>
                              ...
                              <td ><a href="<?php echo base_url();?>appointment/successful_appointment/<?php echo $ts->id;?>" onclick="return confirm('Are sure to accept ?');"><button type="button" class="btn btn-info add">ACCEPT</button></a>  
                              <a href="<?php echo base_url();?>appointment/cancel_appointment/<?php echo $date;?>/<?php echo $ts->id;?>" onclick="return confirm('Are sure to delete ?');"><button type="button" class="btn btn-info remove">REMOVE</button></a></td>
                            </tr>
                          </tbody>
                        </table>
                      <?php } ?>
                        ...
                        <thead>
                          ...
                          <tbody>
                            <tr>
                              ...
                              <td ><?php echo $ts->mobileno;?></td>
                              <td ><?php echo $ts->patienttype;?></td>
                              <td ><a href="<?php echo base_url();?>appointment/successful_appointment/<?php echo $ts->id;?>" onclick="return confirm('Are sure to accept ?');"><button type="button" class="btn btn-info add">ACCEPT</button></a>  <a href="<?php echo base_url();?>appointment/cancel_appointment/<?php echo $date;?>/<?php echo $ts->id;?>" onclick="return confirm('Are sure to delete ?');"><button type="button" class="btn btn-info remove">REMOVE</button></a></td>
                            </tr>
                          </tbody>
                        </table>
                      <?php } ?>
