n<?php $this->load->view('header', array('num' => 1, 'title' => 'Remove Appointment')); ?>
		...
		<form method="post" action="<?php echo base_url();?>cadmin/add_patient" role="form">
			<div class="row clearfix">
				...
				<div class="row" style="margin:10px 50px;">
					...
					<legend>Remove Appointment</legend>
			        <span>DATE</span>
			        ...
			        <button type="submit" class="btn btn-danger">Remove Appointment</button><br><br>
					</div>
				</div>
			</div>
		</form>
