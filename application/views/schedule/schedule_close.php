<?php $this->load->view('header', array('num' => 1, 'title' => 'Close Schedule')); ?>
		...
		<form method="post" action="<?php echo base_url();?>cadmin/add_patient" role="form">
			<div class="row clearfix">
				...
				<div class="row" style="margin:10px 50px;">
			        ...
			        <button type="submit" class="btn btn-danger">Close Schedule</button><br><br>
					</div>
				</div>
			</div>
		</form>
