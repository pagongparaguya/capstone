  ...
  <div class="element-container" style="padding: 25px;">
              ...
              <div class="row clearfix">
                <div class="col-lg-6 columns">
                  ...
                  <label for="profile-fname">Username</label>
                  <input id="profile-fname" class="form-control" placeholder="This serves as your identifier" name="uname" type="text" required /><br>
